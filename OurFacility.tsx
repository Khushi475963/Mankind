...
const OurFacility: React.FC<Props> = ({ selectedLanguage }) => {
  ...
  const facilityItems: FacilityItem[] = [
    ...
    { 
      name: "Central Oxygen & Suction System", 
      description: "Wall-mounted medical gas supply in all critical care areas.",
      icon: Wind, iconBg: "bg-sky-50", iconColor: "text-sky-500" 
    },
    { 
      name: "Blood Storage / Bank Tie-up", 
      description: "Seamless access to blood products for surgical needs.",
      icon: Droplets, iconBg: "bg-red-50", iconColor: "text-red-600" 
    },
    { 
      name: "Digital Medical Records", 
      description: "Cloud-synced longitudinal health history for every patient.",
